...
export default function MorningAlarm() {
  ...
  const sendUDPCommand = (darkness, buzzer) => {
    ...
    console.log(
      `📡 Sent UDP: ${darkness === 0 && buzzer === 0 ? 'C0' : 'E4'} ${darknessValue} ${buzzerVal}`
    );
  };
  ...
  const handleToggle = () => {
    ...
    const message = newState
      ? Buffer.from([0xe8, darknessValue, buzzerVal]) // Send values with E0
    ...
    console.log(
      `📡 Sent UDP: ${newState ? 'E0' : 'C0'} ${
        newState ? `${darknessValue} ${buzzerVal}` : ''
      }`
    );
  };
        ...
        <View style={styles.headerContainerWrapper}>
          <View style={styles.headerContainer}>
            <View style={styles.headerContent}>
              ...
              />
              <Text style={styles.headerText}>Liquid Dispenser</Text>
            </View>
          </View>
        </View>
          ...
          <View style={styles.controlsRow}>
            ...
            <View style={styles.controlContainer}>
              ...
              >
                <View style={styles.slider}>
                  <View
                    style={[styles.sliderTrack, { width: `${buzzerValue}%` }]}
                  />
                  <View
                    style={[styles.sliderThumb, { left: `${buzzerValue}%` }]}
                  />
                </View>
              </View>
            </View>
