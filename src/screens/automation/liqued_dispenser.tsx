...
export default function HomeSecurity() {
  ...
  const sendUDPCommand = (light, buzzer) => {
    ...
    const message = Buffer.from([0xE8, lightValue, buzzerValue]);
      ...
      <View style={styles.controlsBox}>
        <View style={styles.topRow}>
          <View style={styles.controlGroup}>
            <Text style={styles.label}> <Text style={styles.boldText}>Liqued Dispensor {isOn ? 'ON' : 'OFF'}</Text></Text>
            <Switch
        ...
        <View style={styles.controlGroup}>
          <Text style={styles.label}>💡 Thresshold Distance {lightIntensity}</Text>
          <Slider
            style={styles.slider}
            minimumValue={0}
            maximumValue={100}
        ...
        <View style={styles.controlGroup}>
          <Text style={styles.label}>⏲️ Time: {buzzerTime}</Text>
          <Slider
            style={styles.slider}
            minimumValue={0}
            maximumValue={100}
