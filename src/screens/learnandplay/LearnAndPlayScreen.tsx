...
const GradientBackground = ({ children }) => {
  console.log("Rendering GradientBackground"); // DEBUG
  return (
...
const HexagonButton = ({ label, color, style }) => {
  console.log(`Rendering HexagonButton with label: ${label} and color: ${color}`); // DEBUG
  return (
...
const LearnAndPlayScreen: React.FC = () => {
  ...
  console.log("LearnAndPlayScreen Rendered"); // DEBUG

  const handlePlayPress = () => {
    console.log("Play button pressed"); // DEBUG
  ...
  return (
    <GradientBackground>
      ...
      {/* Title */}
      <Text style={styles.title}>Let's Learn & Play!</Text>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.7}
        onPress={() => {
          console.log("Play button onPress triggered"); // DEBUG
          setIsPressed(true);
          handlePlayPress();
      ...
      <HexagonButton label="Robotic" color="#7be57b" style={styles.roboticHex} />
